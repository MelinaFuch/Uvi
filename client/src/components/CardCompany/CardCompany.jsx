      ...
      <form ref={form} onSubmit={sendEmail} className={style.form}>
        ...
        <div className={style.userModalidad}>
          ...
          <div className={style.checkboxContainer}>
            <label>
              <input type="checkbox" name="user_modalidad" value="Presencial" />
              Presencial
            </label>
            <label>
        ...
        <p className={style.aclaracion}>
          Por el momento no hacemos búsquedas personalizadas en base a otros
          requerimientos específicos.
        </p>
        <button
          type="submit"
          className={style.companyButton}
          disabled={!form.current?.user_name?.value}
        >
          Suscribirse
        </button>
      </form>
